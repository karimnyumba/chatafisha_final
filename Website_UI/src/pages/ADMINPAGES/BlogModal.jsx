          ...
          Enter details to edit the article
                    ...
                    <div className=" text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                      ...
                      <div className="flex flex-col">
                        ...
                        <textarea rows={4} type="text" name="description"  className="focus:border-indigo-500 mt-1 block w-full border rounded-md" defaultValue={blog != null ? blog.description : ''} />
                      </div>
                    </div>
        </ModalBody>
        <ModalFooter>
