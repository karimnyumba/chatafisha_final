...
function TupeSupport() {
  ...
  return (
    <div
      className="bg-cover bg-no-repeat bg-white_A700 flex flex-col font-syne h-auto sm:h-[100%] items-center justify-start mx-auto p-[38px] sm:px-5 w-full"
      style={{ backgroundImage: "url('images/img_homepage.png')" }}
    >
      <div className="w-full">
        <NavBar />
      </div>
      <div className="flex flex-row sm:flex-wrap md:flex-wrap gap-6 justify-center align-middle space-x-16 mt-[50px] w-[90%]">
