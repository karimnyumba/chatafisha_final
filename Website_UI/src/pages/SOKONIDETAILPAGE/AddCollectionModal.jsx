...
const schema = yup
  .object({
    ...
    amount: yup
      .string()
      .required("Please provide Amont! "),
    //type of plastic
    type: yup
      .string()
      .required("Please select your type of plastic"),
      ...
      <ModalBody>
        <div className="flex flex-col gap-6 items-center mt-[29px] w-full ">
         ...
         <div className='form-row row'>
              ...
              <label htmlFor="" className="text-xs">Type of plastic Collected</label>
               <div className="col-md-12 mb-3">
                  <Select options={options} />
               </div>
               
               <label htmlFor="" className="text-xs">Add a picture of proof</label>
              <div className='col-md-12 mb-3'>
                <input
                  type='file'
